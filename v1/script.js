...
async function loadFacts() {
  const res = await fetch('https://xbbczrvjilrvumcislzz.supabase.co/rest/v1/facts', {
    headers: {
      apikey:
      ...
      authorization:
        'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhiYmN6cnZqaWxydnVtY2lzbHp6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2NzI2ODg0MTQsImV4cCI6MTk4ODI2NDQxNH0.VGYvSlX6XOEnoJ5o3J_TDEualQRnkVFRDtngIur6T94',
    },
  });
